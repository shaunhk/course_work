...
class TestFriends < MiniTest::Test
  ...
  def test_checking_food_true
    result = like_food(@person3, "Scooby snacks")
    assert_equal(true, result)
  end

  def test_checking_food_false
    result = like_food(@person3, "potato")
  ...
  def test_loaned_money
    loan_money(@person3, @person2, 10)
    result1 = @person2[:monies]
    assert_equal(result1, 12)
